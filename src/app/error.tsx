    ...
    return (
        <div className="min-h-[400px] flex items-center justify-center p-4">
            <div className="max-w-md w-full text-center">
                ...
                <h2 className="text-[32px] leading-[120%] bold font-sans mb-2">Something went wrong!</h2>
               {error.message && (<p className="mb-2 px-4 text-[14px] leading-[150%] normal overflow-hidden text-ellipsis max-h-24">{error.message}</p>)}
